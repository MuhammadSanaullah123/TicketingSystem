...
const BusDetails = () => {
  ...
  return (
    <>
      ...
      <PageTitle>Bus Details</PageTitle>
      {/* {loading ? (
          ...
          <div className="flex flex-col lg:flex-row md:flex-row w-full overflow-hidden">
            ...
            <div className="w-full flex flex-col p-5 md:p-8 text-left">
              <div className="mb-5 block ">
                ...
                <h2 className="text-heading text-lg md:text-xl lg:text-2xl font-semibold font-serif">
                  {/* {data.title} */}
                </h2>
              ...
              <div className="flex flex-col mt-4">
                ...
                <div className="flex flex-row">
                  {/* {JSON.parse(data?.tag).map((t, i) => (
                    <span
                      key={i + 1}
                      className="bg-gray-200 mr-2 border-0 text-gray-500 rounded-full inline-flex items-center justify-center px-2 py-1 text-xs font-semibold font-serif mt-2"
                    > */}
                      {/* {t} */}
                    {/* </span>
                  ))} */}
