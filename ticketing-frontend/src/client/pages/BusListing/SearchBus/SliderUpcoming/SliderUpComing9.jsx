...
export default function SliderUpcoming9(props) {
  ...
  const [currentMonth, setCurrentMonth] = useState(newData2);
  ...
  const renderCells = () => {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      if (index === 0) {
        ...
        if (i === 0 && data.length > 4 && flagInner === false) {
      ...
      if (index === 1) {
        ...
        console.log("dataUnshiftBeforIFdata.length", data.length);
