export const doughnutLegends = [
  { title: 'Luxury Class', color: 'bg-green-500' },
  { title: 'Executive Class', color: 'bg-blue-500' },
  { title: 'Executive Plus', color: 'bg-orange-500' },
  { title: 'Business Class', color: 'bg-indigo-500' },
];
...
export const doughnutOptions = {
  data: {
    ...
    labels: ['Luxury Class', 'Executive Class', 'Executive Plus', 'Business Class'],
  },
  options: {
    responsive: true,
    cutoutPercentage: 80,
