...
const Map = ({
  ...
  const handleLocation = (index) => {
    ...
    const updatedLocations = [...user.locations];
    updatedLocations[index] = { lat, lng };
  ...
  return (
    <>
      ...
      <div className="col-span-8 sm:col-span-4 mapDiv">
        ...
        {currentMap?.lat && <CheckCircleIcon className="checkIcon" />}
        {busStation?._id && (
          <DeleteIcon
            onClick={() => removeBusStation(busStation._id)}
            style={{
              color: "#ff4444",
              marginLeft: "15px",
            }}
          ...
          <ModalBody>
            <div style={{ height: "50vh", position: "relative" }}>
              <GoogleMapReact
                ...
                defaultZoom={currentMap ? 15 : defaultProps.zoom}
                center={
                  currentMap && currentMap?.lat ? currentMap : mapOptions.center
                }
                zoom={currentMap?.lat ? 15 : mapOptions.zoom}
